...
public class LoginActivity extends AppCompatActivity {
    ...
    String[] mensagens = {"Preencha todos os campos", "A senha está curta precisa ter 6 digitos", "Login Realizado com sucesso"};
    ...
    private void TelaPrinciapl() {
        Intent intent = new Intent(LoginActivity.this, CalendarViewWithNotesActivitySDK21.class);
        startActivity(intent);
        finish();
    }
